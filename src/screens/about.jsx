  ...
  return (
    <div id="aboutPage">
      ...
      <section id="about-page-content" className="container-fluid p-0">
        <div className="row p-0">
          ...
          <div className="col-12 col-md-6">
            ...
            <div id="features3">
              <div className="mt-5">
                <p className="title text-start text-muted">2.12 billion</p>
                <p className="mb-0 text-muted">
                  Mark's experience has been the essential pillar in building
                  Eden Utilities products, whilst his ethos determined the
                  company's.
                </p>
              </div>

              <div className="mt-5">
                <p className="title text-start text-muted">less than 20%</p>
                <p className="mb-0 text-muted">Mark's experience has been</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="utility-experts">
          <div className="content-width px-4 px-md-4">
            <div className="title text-start">Looking for Utility Experts?</div>
          ...
          <div id="features">
            <div>
              <p>Expert-led, People-first</p>
              <p>Sustainability at the Core</p>
              <p>Smarter Energy Strategies</p>
              <p>Independent and Transparent</p>
              <p>Carbon-Aware and Future-Ready</p>
              <p>Flexible Support That Fits You</p>
            </div>
          </div>
        </div>
      ...
      <div id="partnership" className="container-fluid p-0">
        <div className="content-width px-4 px-md-4">
          <div className="title text-start">PARTNERSHIP WITH ALL CLIENTS</div>
          <p className="long-content text-black text-start">
            Eden Utilities pride itself on working in partnership with all
            clients, to ensure that they are receiving not only the best price
            from their utilities suppliers, but also the best value
          </p>
